...
## $ export DEBUG_LEFTWM=true
is_debug () {
	if [ "$DEBUG_LEFTWM" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	THE_MAIN_LEFTWM_CONFIG_DIR_PATH="$(find_dir_path "$THE_BASE_DIR_PATH/../../../.")"
	THE_MAIN_LEFTWM_CONFIG_FILE_PATH="$THE_MAIN_LEFTWM_CONFIG_DIR_PATH/config.toml"

	THE_MAIN_LEFTWM_THEME_CONFIG_DIR_PATH="$THE_PLAN_DIR_PATH"
	THE_MAIN_LEFTWM_THEME_CONFIG_FILE_PATH="$THE_MAIN_LEFTWM_THEME_CONFIG_DIR_PATH/theme.toml"

	THE_MAIN_LEFTWM_UP_FILE_PATH="$THE_MAIN_LEFTWM_THEME_CONFIG_DIR_PATH/up"
	THE_MAIN_LEFTWM_DOWN_FILE_PATH="$THE_MAIN_LEFTWM_THEME_CONFIG_DIR_PATH/down"

	THE_MAIN_LEFTWM_WALLPAPER_ON_DOWN_FILE_PATH="$THE_MAIN_LEFTWM_THEME_CONFIG_DIR_PATH/bg-down.jpg"
	THE_MAIN_LEFTWM_WALLPAPER_ON_UP_FILE_PATH="$THE_MAIN_LEFTWM_THEME_CONFIG_DIR_PATH/bg-up.jpg"
...
base_var_dump () {
	...
	util_debug_echo "THE_MAIN_LEFTWM_CONFIG_DIR_PATH=$THE_MAIN_LEFTWM_CONFIG_DIR_PATH"
	util_debug_echo "THE_MAIN_LEFTWM_CONFIG_FILE_PATH=$THE_MAIN_LEFTWM_CONFIG_FILE_PATH"

	util_debug_echo "THE_MAIN_LEFTWM_THEME_CONFIG_DIR_PATH=$THE_MAIN_LEFTWM_THEME_CONFIG_DIR_PATH"
	util_debug_echo "THE_MAIN_LEFTWM_THEME_CONFIG_FILE_PATH=$THE_MAIN_LEFTWM_THEME_CONFIG_FILE_PATH"

	util_debug_echo "THE_MAIN_LEFTWM_UP_FILE_PATH=$THE_MAIN_LEFTWM_UP_FILE_PATH"
	util_debug_echo "THE_MAIN_LEFTWM_DOWN_FILE_PATH=$THE_MAIN_LEFTWM_UP_FILE_PATH"

	util_debug_echo "THE_MAIN_LEFTWM_WALLPAPER_ON_DOWN_FILE_PATH=$THE_MAIN_LEFTWM_WALLPAPER_ON_DOWN_FILE_PATH"
	util_debug_echo "THE_MAIN_LEFTWM_WALLPAPER_ON_UP_FILE_PATH=$THE_MAIN_LEFTWM_WALLPAPER_ON_UP_FILE_PATH"
